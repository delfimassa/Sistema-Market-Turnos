...
const motivos = [
  { op: "Urgencia", ph: " Ej: Tengo una urgencia por accidente de mi mascota" },
  { op: "Peluqueria", ph: "Ej: Necesito corte de pelo y baño" },
  { op: "Vacunatorio", ph: "Ej: Necesito vacunas del año" },
  { op: "Castraciones", ph: "Ej: Necesitocastrar mi perro de 6 meses" },
  {
    op: "Controles",
    ph: "Ej: Necesito Controles por mascota encontrada sin dueño",
  },
  {
    op: "Clinica",
    ph: "Ej: Necesito Control de mi mascota por infeccion,parasitos, etc",
  },
  { op: "Guarderia", ph: "Ej: Necesito Hospedaje por 3 dias de mi mascota" },
];
const horarios = [
  "09:15",
  "09:30",
...
export default function ModalTurnos({
  ...
  const handleSubmit = async (event) => {
    ...
    //const ab=moment(turno.diaHoraTurno,moment.ISO_8601);
  ...
  const sDomingos = (e) => {
    ...
    if (day == 6) {
      alert(
        "Lo sentimos, los domingos la clínica se encuentra cerrada. Por favor, ingrese un día distinto."
      );
    ...
    <div>
      <Form onSubmit={handleSubmit}>
        <Modal.Dialog>
          ...
          {bandera2 ? (
            <div>
              <p className="line anim-typewriter mt-5  fuente">¡Excelente!</p>
              <p className="line anim-typewriter mt-1 mb-3 fuente">
          ...
          {bandera && bandera2 ? (
            <div className="">
              <p className="line anim-typewriter mt-5 mb-3 fuente">
